...
/**
 * Servlet implementation class AddJoueurSrv
 */
@WebServlet("/AddJoueurSrv")
public class AddJoueurSrv extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			getServletContext().getRequestDispatcher("/addJoueur.jsp").forward(request, response);
