...
/**
 * Servlet implementation class UpdateJoueurSrv
 */
@WebServlet("/UpdateJoueurSrv")
public class UpdateJoueurSrv extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateJoueurSrv() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    try {
	    	ArrayList<JoueursModel> infos = JoueursModel.Joueur(id);
	        //clubModel.ajouterClub(param1, param2,  param3, param4);
	        request.setAttribute("JoueurInfos", infos);
	        ...
	        getServletContext().getRequestDispatcher("/modifierJoueur.jsp").forward(request, response);
