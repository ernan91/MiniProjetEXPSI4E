...
<%
    ...
    <div class="mb-3">
    <label for="club" class="form-label">Club extérieur</label>
    <select <%out.println(m.getClubExtNom());%> class="form-select" id="club_extérieur" name="club_extérieur"   required>
...
<%
	...
	<input value="<% out.println(m.getResultat()); %>" id="resultat-input" type="text" class="form-control" placeholder="Résultat">
	</div>
