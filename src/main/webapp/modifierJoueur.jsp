...
<%
		...
		ArrayList<JoueursModel> joueur=(ArrayList<JoueursModel>)request.getAttribute("JoueurInfos");
		for(JoueursModel j:joueur)
		{
%>
 <div class="mb-3" >
    <input hidden type="text" class="form-control" id="id" name="nom" value="<% out.println(j.getId());%>" required>
  </div>
  <div class="mb-3">
    <label for="nom" class="form-label">Nom</label>
    <input type="text" class="form-control" id="nom" name="nom" value="<% out.println(j.getNom());%>" required>
  </div>
  <div class="mb-3">
    <label for="prenom" class="form-label">Prénom</label>
    <input type="text" class="form-control" id="prenom" name="prenom" value="<% out.println(j.getPrenom());%>" required>
  </div>
  <div class="mb-3">
    <label for="age" class="form-label">Age</label>
    <input type="text" class="form-control" id="age" name="age" value="<% out.println(j.getAge());%>" required>
  </div>
    <div class="mb-3">
		      <label for="club" class="form-label">Poste</label>
		<select class="form-select" id="poste" name="poste" required>
		  <option value="<% out.println(j.getPoste());%>" ><% out.println(j.getPoste());%></option>
